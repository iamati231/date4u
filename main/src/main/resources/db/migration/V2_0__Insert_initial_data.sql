INSERT INTO Profile (birthdate, nickname, hornlength, gender, attracted_to_gender, description, lastseen)
VALUES (DATE '1980-08-16', 'FillmoreFat', 3, 1, 0, 'Damn, Eskel... you got an hourglass figure',
        TIMESTAMP '2021-07-03 22:57:55'),
       ...
       (DATE '1987-05-06', 'DanSing', 27, 0, 1, 'Careful man, there''s a beverage here!',
        TIMESTAMP '2021-06-22 15:57:56'),
       (DATE '1979-07-17', 'AdamZapel', 0, 1, 1, 'Customer Producer looking for love', TIMESTAMP '2021-08-26 09:57:56'),
       (DATE '1994-11-10', 'DesPratt', 13, 0, 1, 'Lets travel to Triangulum together <3',
        TIMESTAMP '2021-06-17 06:57:57'),
       (DATE '1996-08-02', 'DinahMite', 25, 2, 2,
        'I''ll stick me boot so far up yer arse your tongue''ll taste like wench twat',
        TIMESTAMP '2021-10-18 18:57:57'),
       (DATE '1994-07-10', 'WoodyForrest', 17, 0, 0, 'Dreaming to be part of Creedence Clearwater Revival',
        TIMESTAMP '2021-05-17 15:57:57'),
       (DATE '1989-01-11', 'AmyStake', 27, 0, 2, 'Lets travel to Hoags Object together <3',
        TIMESTAMP '2021-05-22 21:57:57'),
       (DATE '1974-09-12', 'RockyRhoades', 17, 2, 1, 'Education Executive looking for love',
        TIMESTAMP '2021-07-02 03:57:57'),
       (DATE '1989-05-22', 'ChrisCross', 24, 1, NULL, 'Dreaming to be part of The Pretenders',
        TIMESTAMP '2021-09-14 14:57:57'),
       (DATE '1971-07-17', 'CariMysack', 28, 1, 1, 'Lets travel to Milky Way together <3',
        TIMESTAMP '2021-11-03 16:57:57'),
       (DATE '1987-08-31', 'SkipStone', 13, 1, 1, 'Chief Strategist looking for love', TIMESTAMP '2021-09-30 13:57:57'),
       (DATE '1975-04-05', 'EstelleHertz', 16, 2, 0,
        'Did u know that Chuck Norris doesn''t need garbage collection because he doesn''t call .Dispose(), he calls .DropKick().',
        TIMESTAMP '2021-10-01 20:57:58'),
       (DATE '1996-02-21', 'ConnieLingus', 23, 2, 0, 'Senior Hospitality Representative looking for love',
        TIMESTAMP '2021-08-23 04:57:58'),
       (DATE '1993-09-27', 'TomKatz', 0, 1, 0,
        'I''ll stick me boot so far up yer arse your tongue''ll taste like wench twat',
        TIMESTAMP '2021-09-05 07:57:58'),
       (DATE '1971-07-31', 'EddieBull', 28, 0, 1, 'No Lollygagin''!', TIMESTAMP '2021-09-11 01:57:58'),
       (DATE '1974-09-27', 'JimShu', 1, 0, 0, 'I want that Mulan McNugget sauce, Morty!',
        TIMESTAMP '2021-08-17 23:57:58');

INSERT INTO Unicorn (email, password, profile_fk)
VALUES ('fillmore.fat@wyman.co', '{noop}u87szdzwr6j', 1),
       ...
       ('theresa.green@willms.nickname', '{noop}ltn0zt643qey38', 6),
       ...
       ('estelle.hertz@yundt.nickname', '{noop}lp6reyj1vsb', 16),
...
VALUES (20, 'unicorn001', TRUE, TIMESTAMP '1999-08-17 00:00:00'),
